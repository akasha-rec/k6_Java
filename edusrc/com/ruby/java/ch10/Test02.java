...
public class Test02 {
	...
	public static void main(String[] args) {
		...
		ArrayList lst = new ArrayList(); // 아무것도 없을 때 Object
		...
		for (String element : list) { //배열 원소 개수만큼 for문 돌아
		...
		//iterator() method - 컬렉션 개체를 Iterator 객체로 변환하여 반환 = String 객체들의 집합
		//Iterator<String> : 클래스, iterator가 다 읽어와서 {원소 10개인 set}을 만들어 ★
		//iter 참조변수인데 커서로 생각하면 됨
		//iter.hasNext() > 커서 다음 데이터가 있나? true or false 반환하고 나서 다음으로 커서가 넘어가고 다음 데이터를 가리켜 ★
