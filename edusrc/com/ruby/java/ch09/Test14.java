package com.ruby.java.ch09; //p 432 ~ StringTokenizer Class
//iterator 개념 실습 
...
public class Test14 {
	public static void main(String[] args) {
		...
		StringTokenizer st1 = new StringTokenizer(msg); //자체적으로 문자열을 분리(token)하는 기능 - String의 split() : String 배열로 분리된 문자열
