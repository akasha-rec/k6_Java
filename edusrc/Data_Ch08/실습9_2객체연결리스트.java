...
public class 실습9_2객체연결리스트 {
	...
	public static void main(String[] args) {
		Menu menu;                               
		LinkedList2 l = new LinkedList2(); //첫번째 리스트
		LinkedList2 l2 = new LinkedList2();//두번째 리스트를 for loop로 만들어서
		Scanner sc = new Scanner(System.in);
		...
		do {
			...
			case Add :                          
				...
				data.scanData("입력", 3);//왜 3?
				l.Add(data, SimpleObject5.NO_ORDER);//회원번호 순서로 정렬 입력 SimpleObject5.NO_ORDER > comparator
				break;
			case Delete :                         
				data = new SimpleObject5();
			...
			case Merge://난이도 상
				...
				l.Merge(l2);//첫번째 리스트 l + 두번째 리스트 l2 merge
				break;
			case Exit :                           // 꼬리 노드 삭제
				break;
			}
